;(function (define) {
    ...
    define('eucalyptus-theme-codebase/js/discovery/discovery_factory',
        ['backbone', 'eucalyptus-theme-codebase/js/discovery/models/search_state', 'js/discovery/collections/filters',
        'js/discovery/views/search_form', 'eucalyptus-theme-codebase/js/discovery/views/courses_listing',
